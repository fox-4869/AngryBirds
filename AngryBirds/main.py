...
def loading():
    ...
    init_background = pygame.image.load(
        "E:/py/AngryBirds/images/mainPicture.jpg").convert_alpha()
...
def menu():
    ...
    menu_background = pygame.image.load(
        "E:/py/AngryBirds/images/menu.jpg").convert_alpha()
    pygame.display.set_caption('AngryBirds')
    ...
    # 背景音乐
    song1 = 'E:/py/AngryBirds/music/title_theme.wav'
...
redbird = pygame.image.load(
    "E:/py/AngryBirds/images/red-bird3.png").convert_alpha()
background2 = pygame.image.load(
    "E:/py/AngryBirds/images/background3.png").convert_alpha()
sling_image = pygame.image.load(
    "E:/py/AngryBirds/images/sling-3.png").convert_alpha()
full_sprite = pygame.image.load(
    "E:/py/AngryBirds/images/full-sprite.png").convert_alpha()
# 扣完全猪
...
buttons = pygame.image.load(
    "E:/py/AngryBirds/images/selected-buttons.png").convert_alpha()
# 失败->猪
pig_happy = pygame.image.load(
    "E:/py/AngryBirds/images/pig_failed.png").convert_alpha()
# 三星
stars = pygame.image.load(
    "E:/py/AngryBirds/images/stars-edited.png").convert_alpha()
...
def load_music():
    song1 = 'E:/py/AngryBirds/music/ambient_red_savannah.wav'
    pygame.mixer.music.load(song1)
    pygame.mixer.music.play(-1)
...
def draw_level_cleared():
    ...
    if level.number_of_birds >= 0 and len(pigs) == 0:
        ...
        music_flag += 1
        if music_flag == 2:
            song_win = 'E:/py/AngryBirds/music/level clear military a1.wav'
...
def draw_level_failed():
    ...
    if level.number_of_birds <= 0 and time.time() - t2 > 5 and len(pigs) > 0:
        ...
        music_flag += 1
        if music_flag == 2:
            song_win = 'E:/py/AngryBirds/music/level failed piglets a1.wav'
            pygame.mixer.music.load(song_win)
            pygame.mixer.music.play(0)
            music_flag = 0
        rect = pygame.Rect(300, 0, 600, 800)
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if (pygame.mouse.get_pressed()[0] and
            ...
            music_flag += 1
            if music_flag == 2:
                song_rope = 'E:/py/AngryBirds/music/slingshot streched.wav'
